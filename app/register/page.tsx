  ...
  return (
    <div className="min-h-screen bg-muted/50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-secondary/20 rounded-full blur-3xl animate-pulse" style={{animationDelay: '2s'}}></div>
      </div>
      ...
      <div className="relative max-w-md w-full space-y-8 animate-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-muted-foreground">
            Join EventEase and start managing events effortlessly
          </p>
        </div>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                >
                  <option value="OWNER">Event Owner - Create and manage your own events</option>
                  <option value="STAFF">Staff - Help manage events for organizations</option>
                  <option value="ADMIN">Admin - Full system access</option>
                </select>
                <p className="text-sm text-muted-foreground">Choose the role that best describes your intended use</p>
              </div>
